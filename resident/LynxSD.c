...
////////////////////////////////////////////////////////////////////////////////
	...
	*CART1 = byte;
...
 static void __fastcall__ WriteBytes(unsigned char *pBuf,
				       unsigned int nSize)  { while (nSize--)
		  ...
		   static void __fastcall__ ReadBytes(unsigned char *pOut,
							unsigned int size)  {
